...
shivamsharma2023@gmail.com | (585) 481-9927 | linkedin.com/in/shivamsharma-ai | shivam.website
...
- Spun off **standalone email triage agent** (launched at NEP); shipped **VaultIQ**, an air-gapped financial intelligence platform running Claude Opus on Bedrock for internal CRO use; built **3-workflow conference outreach automation** (n8n, Teams approvals, Outlook) for executive pipeline.
- **Stack:** FastAPI, AWS Bedrock, n8n, React, Next.js, Postgres/pgvector, Terraform, Teams, Outlook, Claude Code.

**Summer Associate, Product (AI)** | *Stealth AI Startup* | Pleasanton, CA | May 2025 - December 2025

- Owned 0-to-1 MVP of voice AI coaching platform as sole PM; landed first paying client (**30 employees**) and triggered seed funding milestone.
- Designed closed-loop voice engine with real-time transcription, sentiment and commitment scoring, auto-generated reports, and privacy-first data model.
...
**MS, Artificial Intelligence in Business (STEM)**, Simon Business School, University of Rochester | December 2025
*VP Events, Masters Advisory Council (Sep 2024 - Aug 2025); Simon Strong Community Builder Award.*

**McKinsey Forward Program**, McKinsey & Company | 2026 - Present

**BA (Honours), International Business and Management**, University of Central Lancashire | May 2020
